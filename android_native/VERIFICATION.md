...
- `artifacts/MC-Atlas-debug.apk`：19,849,679 字节，SHA-256 `BC81DA0353A7C259540816F4A7963A90D5089AD744FD0F4C89589F2C5B56FA07`。
- 用户要求进一步强化 MC 游戏菜单风格，已完成上述修正；最后一次截图时设备息屏，游戏菜单版本的最终实屏复核及保存/应用手动复测仍待反馈。完整文件选择器往返、所有字体/图片格式组合、真实触感与长期稳定性不作为已完成的自动验证。
